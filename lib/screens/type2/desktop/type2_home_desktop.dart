...
class Type2HomeDesktop extends StatelessWidget {
  const Type2HomeDesktop({super.key});
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Manage your content, track engagement, and publish with ease.',
                                  style: TextStyle(
                                    fontSize: 16,
                                    color: Colors.white.withValues(alpha: 0.9),
                                  ),
